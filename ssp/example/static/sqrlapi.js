...
var sqrlApiDomain = 'http://localhost:8080/sqrl';	// the location of the SQRL server
...
//============================================================================//
function getSqrlNut() {
    syncQuery2.open('GET', sqrlApiDomain + '/nut.json');		// the page's DOM is loaded
...
function pollForNextPage() {
    ...
    syncQuery1.open('GET', sqrlApiDomain + '/pag.sqrl?nut=' + sqrlNut);	// the page is visible, so let's check for any update
